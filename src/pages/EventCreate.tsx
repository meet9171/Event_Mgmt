      ...
      <div className="bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="bg-[#6B46C1] p-6">
          ...
          <p className="text-sm sm:text-base text-purple-100 text-center mt-2">
            Fill in the details for your event. Fields marked with * are required.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="mt-8 text-right">
            <button
              type="submit"
              className="w-full sm:w-auto px-6 py-3 bg-[#6B46C1] text-white font-semibold rounded-lg hover:bg-[#5A3F9E] focus:outline-none focus:ring-2 focus:ring-[#6B46C1] focus:ring-offset-2 transition duration-300 ease-in-out transform hover:scale-105"
            >
              Create Event
            </button>
          </div>
